...
const styles = StyleSheet.create({
  ...
  profileLabel: { color: "#D4D4D8", fontSize: 12 },
  profileValue: {
    marginTop: 4,
    color: "#FFFFFF",
    fontSize: 16,
  ...
  galleryButtonDark: { backgroundColor: "rgba(255,255,255,0.07)", borderColor: "rgba(255,255,255,0.18)" },
  galleryButtonLight: { backgroundColor: "rgba(255,255,255,0.07)", borderColor: "rgba(255,255,255,0.2)" },
  galleryButtonText: { fontWeight: "700" },
  galleryButtonTextDark: { color: "#FFFFFF" },
  galleryButtonTextLight: { color: "#FFFFFF" },
  ...
  moodOptionLight: { borderColor: "rgba(255,255,255,0.25)", backgroundColor: "rgba(255,255,255,0.07)" },
